...
st.title(" :bar_chart: Triple Track Garage")
st.markdown(
    '<style>div.block-container{padding-top:2.5rem;} </style>', unsafe_allow_html=True)
...
if fl is not None:
    ...
    os.chdir(r"C:\Users\Louie Sabularse\Desktop\Streamlit")
